              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List
                      text=" Personnalisable pour maganiser les besoins
"
                    />
                    <List
                      text=" Des intégrations faciles et extensibles

"
                    />
                    <List
                      text=" Principes de base de la comptabilité de sécurité
...
"
                  ...
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List
                      text=" Système d'apprentissage intégré

"
                    />
                    <List
                      text=" Gouvernance et audit conformes
