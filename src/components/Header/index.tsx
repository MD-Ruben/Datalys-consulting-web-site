                    ...
                    {menuData.map((menuItem, index) => (
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            href={menuItem.path}
                            className={`font-title flex py-2 text-sm lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-base ${
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, index) => (
                                <Link
                                  ...
                                  key={index}
                                  className="font-title block rounded py-2.5 text-sm text-dark hover:text-primary dark:text-white/70 dark:hover:text-white lg:px-3"
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
