        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="relative z-10 w-full px-4 lg:w-5/12 xl:w-4/12">
            <img
              ...
              className="h-full w-full shadow-2xl shadow-cyan-500/50"
              alt="africa map"
            />
            <div className="absolute left-6 top-0">
              <p className="text-lg text-dark">siège social: Côte d'Ivoire</p>
              <p className="text-lg text-dark">2ème siège: Guinée</p>
            </div>
          </div>
        </div>
      </div>
